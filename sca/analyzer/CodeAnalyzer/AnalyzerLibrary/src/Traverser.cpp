...
Traverser::Traverser(Visitor* visitor, bool skipFnDeclBlock) : p_visitor(visitor), p_skipFnDeclBlock(skipFnDeclBlock) {
...
TraverserOne::TraverserOne(Visitor* visitor, bool skipFnDeclBlock): Traverser(visitor, skipFnDeclBlock) {
    // TODO Auto-generated constructor stub
...
void TraverserOne::traverseForBlock(ForBlock* forBlock) {
    ...
    block->acceptTraverser(*this);
    forBlock->acceptVisitor(*p_visitor);
}
...
TraverserAllPath::TraverserAllPath(Visitor* visitor, bool skipFnDeclBlock): Traverser(visitor, skipFnDeclBlock) {
    // TODO Auto-generated constructor stub
...
void TraverserAllPath::traverseForBlock(ForBlock* forBlock) {
    forBlock->acceptVisitor(*p_visitor);
    BasicBlock* block = forBlock->getFirst();
    block->acceptTraverser(*this);

    BasicBlock* next = forBlock->getNext();
    if(next) next->acceptTraverser(*this);
}
